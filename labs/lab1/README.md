...
### :warning: _Данная лабораторная не проверена преподавателем, так как на Нейротехнологиях эта лабораторная не выполняется (тем не менее она проходит тесты)_
